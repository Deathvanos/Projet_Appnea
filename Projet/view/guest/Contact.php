...
<body>
    ...
    <main style="height:900px;">
        ...
        <div>
            <h2 id="Contacter"> Contacter <span id="dégradé"> le support </span>  </h2>
          ...
          <div class="rectangleretour">
            <div class="rectanglebleu">
              ...
              <div>
                ...
                <div class="rectanglequestion">
                    <textarea placeholder="Ecrivez votre question"></textarea>
                  </div>
    
              </div>
              <div class="rectangleenvoyer">
