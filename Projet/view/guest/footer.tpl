...
<footer class="footer">
    <div class="footer_top">
        ...
        <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="index.php?controle=guest&action=conditionsPage"><?php echo $txt['footer_p2_txt1']; ?></a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="index.php?controle=guest&action=errorPage"><?php echo $txt['footer_p2_txt2']; ?></a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="index.php?controle=guest&action=questionsPage"><?php echo $txt['footer_p2_txt3']; ?></a></li>
        </ul>
        </div>
        <div>
