...
<header class="header_all">
    <div class="header_left">
        <a class="header_title" href="index.php?controle=admin&action=mainGuest">
    ...
    <ul class="header_right">
        ...
        <li><a href='index.php?controle=admin&action=errorPage'><?php echo $txt['header_link4']; ?></a></li>
        ...
        <li><a href='index.php?controle=user&action=errorPage'>Manage User</a></li>
        <li><a href='index.php?controle=user&action=errorPage'>Manage Sensor</a></li>
