...
<footer class="footer">
    <div class="footer_top">
        ...
        <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="index.php?controle=modo&action=contactPage"><?php echo $txt['footer_p1_txt2']; ?></a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="index.php?controle=modo&action=contactPage"><?php echo $txt['footer_p1_txt3']; ?></a></li>
        </ul>
        </div>
        <div>
