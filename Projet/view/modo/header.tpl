...
<header class="header_all">
    ...
    <ul class="header_right">
        <li><a href='index.php?controle=modo&action=productPage'><?php echo $txt['header_link1']; ?></a></li>
        <li><a href='index.php?controle=modo&action=teamsPage'><?php echo $txt['header_link3']; ?></a></li>
        <li><a href='index.php?controle=modo&action=FAQPage'><?php echo $txt['header_link4']; ?></a></li>
        <li><a href='index.php?controle=modo&action=manageFAQPage'><?php echo $txt['header_linkM1'];?></a></li>
        ...
        <li class="header_conn"><nav class="header_login">
            ...
            <ul>
                <li><a href="index.php?controle=modo&action=displayProfil"><?php echo $txt['header_link5'];?></a></li>
