...
<body>
    ...
    <main>
        ...
        <form enctype="multipart/form-data" name="ajouter" action=<?php echo "index.php?controle=".$_SESSION['controle']."&action=forgetPassword" ;?> onSubmit="return resetPasswordMail()" method="POST">
