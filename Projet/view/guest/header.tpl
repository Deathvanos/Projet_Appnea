...
<header class="header_all">
    ...
    <ul class="header_right">
        <li><a href='index.php?controle=guest&action=productPage'><?php echo $txt['header_link1']; ?></a></li>
        <li><a href='index.php?controle=guest&action=teamsPage'><?php echo $txt['header_link3']; ?></a></li>
        <li><a href='index.php?controle=guest&action=FAQPage'><?php echo $txt['header_link4']; ?></a></li>
